...
<body>
	<div class="row" id="fullpage">
		...
		<div class="small-5 medium-4 large-3 columns" id="menu">
			...
			<a href="add-actor-movie-relation"><h3>Add Actor to Movie</h3></a>
			<a href="add-director-movie-relation"><h3>Add Director to Movie</h3></a>
		</div>

		<!-- Main Content Div -->
		<div class="small-7 medium-8 large-9 columns" id="main">
			<h2>Welcome</h2>
			<p>Please select one of the links on the left to search, browse or modify the movie database.</p>
		</div>
	</div>
